...
|-------|-------|----------------|
| **Skill** | `.claude/commands/*.md` | Sub-agent behavior needs to change |
...
Create or update `.claude/retro-log.md` with the lesson. This is a running log, not a memory file — it's for auditing what was learned and when.
