Call a tool get-refine-instructions from a shadcn-studio mcp server with the following prompt # and follow all the instructions provided in the response.
