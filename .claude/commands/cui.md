Call a tool get-create-instructions from a shadcn-studio mcp server with the following prompt # and follow all the instructions provided in the response.
