// ---------------------------------------------------------------------------
// Voice Surface Strings — AI-generated UI copy that matches the owner's voice
// ---------------------------------------------------------------------------
...
export const DEFAULT_VOICE_SURFACES: VoiceSurfaces = {
  ...
  noResults:
    "Hmm, I'm not finding anything that matches. Mind rephrasing or telling me more about what you're after?",
...
- The waiting filler should be 1-3 words max, lowercase`,
  ...
  try {
    ...
    console.error("[voice-surfaces] Failed to parse AI response, using defaults");
