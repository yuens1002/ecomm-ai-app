 ...
 *
 * Usage:
 *   npx tsx dev-tools/restore-database.ts                    # Restores from latest backup
 *   npx tsx dev-tools/restore-database.ts db-backup-2025...json  # Restores from specific backup
 */
...
async function restoreDatabase(backupFile?: string) {
  ...
  try {
    ...
    const backupDir = path.join(process.cwd(), "dev-tools", "backups");
