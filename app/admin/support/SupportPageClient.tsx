    ...
    startTransition(async () => {
      ...
      if (result.success && result.license) {
        ...
        toast({
          ...
          description: `Plan: ${result.license.tier}`,
        });
      } else {
        toast({
        ...
        <>
          ...
          >
                  ...
                  {features.map((feature) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <p
                            className={`text-sm ${enabled ? "font-medium" : "text-muted-foreground"}`}
                          >
                            {feature.name}
                          </p>
            ...
            {tier === "PRO" && (
              <div className="flex items-center gap-3 pt-4">
                {catalog.some(
                  (f) => !license.features.includes(f.slug)
                ) && (
                  <Button variant="outline" asChild>
                    <a
        ...
        >
          <div className="rounded-lg border border-dashed border-muted-foreground/25 bg-muted/50 p-6">
            <p className="text-sm text-muted-foreground">
              We&apos;re working on support plans to help you get the most out
              of Artisan Roast. Priority support, dedicated assistance, and more
